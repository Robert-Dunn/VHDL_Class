...
HD_PWD='F:/LAB 5/Sub_ranging/Sub_ranging.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SUB_RANGING_TOP_MODULE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SUB_RANGING_TOP_MODULE.tcl -notrace
