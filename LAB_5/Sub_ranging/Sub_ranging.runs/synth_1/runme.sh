...
HD_PWD='F:/LAB 5/Sub_ranging/Sub_ranging.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SUB_RANGING_TOP_MODULE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SUB_RANGING_TOP_MODULE.tcl
