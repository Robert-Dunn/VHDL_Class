...
HD_PWD='C:/Users/arden.oh/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SAR_top_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SAR_top_module.tcl
