...
HD_PWD='C:/Users/arden.oh/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SAR_top_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SAR_top_module.tcl -notrace
