...
read_vhdl -library xil_defaultlib {{C:/Users/Rob Dunn/Documents/School/ENEL 453/VHDL_Class/Lab3/bouncing_box.vhd}}
...
synth_design -top bouncing_box -part xc7a35tcpg236-1


write_checkpoint -force -noxdef bouncing_box.dcp

catch { report_utilization -file bouncing_box_utilization_synth.rpt -pb bouncing_box_utilization_synth.pb }
